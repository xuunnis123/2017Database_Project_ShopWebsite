...
$result = mysqli_query($db, "Update accessories SET a_ID = '$a_ID', store_name = '$store_name', name = '$name', price = '$price', picture = '$picture',  web = '$web' WHERE a_ID = '$a_ID'") or die('MySQL update error');

$result = mysqli_query($db, "select * from accessories") or die('MySQL query error');
?>
...
echo "<caption style=\"text-align:left; font-size:36px;\">飾品修改</caption>\n";
echo "\n";
echo "<tbody>\n";  
echo "<tr>\n";
echo "<th style=\"background-color:#DDDDDD\";>飾品ID</th>\n";
echo "<th style=\"background-color:#DDDDDD\";>店家名稱</th>\n";
echo "<th style=\"background-color:#DDDDDD\";>飾品名稱</th>\n";
