...
$result = mysqli_query($db, "Update store_info SET store_name = '$store_name', description = '$description', phone = '$phone', website = '$website' WHERE store_name = '$store_name'") or die('MySQL insert error');
