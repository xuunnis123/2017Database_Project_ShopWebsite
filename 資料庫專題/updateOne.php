...
$result = mysqli_query($db, "Update onepiece SET one_ID = '$one_ID', store_name = '$store_name', name = '$name', price = '$price', picture = '$picture',  web = '$web' WHERE one_ID = '$one_ID'") or die('MySQL update error');
