...
$result = mysqli_query($db, "INSERT INTO tops(Tops_ID, store_name, name, price, picture, web) VALUES ('$Tops_ID', '$store_name', '$name', '$price', '$picture', '$web')") or die('MySQL insert error');
