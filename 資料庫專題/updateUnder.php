...
$result = mysqli_query($db, "Update underwear SET under_ID = '$under_ID', store_name = '$store_name', name = '$name', price = '$price', picture = '$picture',  web = '$web' WHERE under_ID = '$under_ID'") or die('MySQL update error');
