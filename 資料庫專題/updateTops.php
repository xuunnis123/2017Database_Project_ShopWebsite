...
$result = mysqli_query($db, "Update tops SET Tops_ID = '$Tops_ID', store_name = '$store_name', name = '$name', price = '$price', picture = '$picture',  web = '$web' WHERE Tops_ID = '$Tops_ID'") or die('MySQL update error');

$result = mysqli_query($db, "select * from tops") or die('MySQL query error');
?>
...
echo "<caption style=\"text-align:left; font-size:36px;\">上衣修改</caption>\n";
echo "\n";
echo "<tbody>\n";  
echo "<tr>\n";
echo "<th style=\"background-color:#DDDDDD\";>衣服ID</th>\n";
echo "<th style=\"background-color:#DDDDDD\";>店家名稱</th>\n";
echo "<th style=\"background-color:#DDDDDD\";>衣服名稱</th>\n";
