...
$result = mysqli_query($db, "INSERT INTO accessories(a_ID, store_name, name, price, picture, web) VALUES ('$a_ID', '$store_name', '$name', '$price', '$picture', '$web')") or die('MySQL insert error');
