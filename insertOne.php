...
$result = mysqli_query($db, "INSERT INTO onepiece(one_ID, store_name, name, price, picture, web) VALUES ('$one_ID', '$store_name', '$name', '$price', '$picture', '$web')") or die('MySQL insert error');
