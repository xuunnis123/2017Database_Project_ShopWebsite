...
$result = mysqli_query($db, "INSERT INTO store_info(store_name, description, phone, website) VALUES ('$store_name', '$description', '$phone', '$website')") or die('MySQL insert error');
