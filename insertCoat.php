...
$result = mysqli_query($db, "INSERT INTO coat(coat_ID, store_name, name, price, picture, web) VALUES ('$coat_ID', '$store_name', '$name', '$price', '$picture', '$web')") or die('MySQL insert error');
